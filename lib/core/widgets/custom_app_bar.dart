...
import 'form_widgets/text_input_field.dart';
...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      leading: backButton != null ? const BackButton(color: ColorsPalette.lightGrey,) : Container(),
      elevation: 0,
      ...
      title: Builder(builder: (context) {
        ...
        return Text(
          title!,
          style: const TextStyle(fontSize: 16, color: ColorsPalette.lightGrey, fontFamily: NSTextStyles.font),
        );
      }),
      actions: [if (actions != null) ...actions! else Container(width: 18.w,)],
      bottom: bottom,
    );
  }
...
class CustomAppBarWithSearch extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppBarWithSearch({
    ...
    this.actions,
    this.bottom,
    this.backButton, this.searchController, required this.onSearchFieldChanged
  }) : super(key: key);
    ...
    return AppBar(
      leading: Padding(
        ...
        child: ContainedIconButton(
          ...
          icon: const Icon(Icons.arrow_back_ios_rounded, color: ColorsPalette.lightGrey,),
          onTap: (){
