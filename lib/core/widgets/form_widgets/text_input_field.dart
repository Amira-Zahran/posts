...
class TextInputField extends StatelessWidget {
  ...
  const TextInputField({
    ...
    this.onSave,
    this.enabled = true,
    this.color, this.inputFormatters, this.backgroundColor, this.enabledBorder, this.focusedBorder, this.prefixIcon, this.suffixIcon,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return FormBuilderTextField(
      ...
      maxLines: maxLines,
      style: TextStyle(fontSize: 13, color: ColorsPalette.lightGrey.withOpacity(0.1)),
...
class TextInputFieldPaste extends StatelessWidget {
  ...
  const TextInputFieldPaste({
    ...
    this.onSave,
    this.enabled = true,
    this.color, this.prefixIcon, this.suffixIcon
  }) : super(key: key);
